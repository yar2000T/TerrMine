...
try:
    ...
    textures = {
        1: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\dirt.png")).convert(screen),
                                  (TILE_SIZE, TILE_SIZE)),
        2: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\grass.png")).convert(screen),
                                  (TILE_SIZE, TILE_SIZE)),
        3: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\stone.png")).convert(screen),
                                  (TILE_SIZE, TILE_SIZE)),
        4: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\brick.png")).convert(screen),
                                  (TILE_SIZE, TILE_SIZE)),
        5: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\diamond.png")).convert(screen),
                                  (TILE_SIZE, TILE_SIZE)),
        6: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\end_bricks.png")).convert(screen),
                                  (TILE_SIZE, TILE_SIZE)),
        7: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\planks_oak.png")).convert(screen),
                                  (TILE_SIZE, TILE_SIZE)),
        8: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\leaves_oak.png")).convert_alpha(screen),
                                  (TILE_SIZE, TILE_SIZE)),
        9: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\log_oak.png")).convert(screen),
                                  (TILE_SIZE, TILE_SIZE)),
        10: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\stonebrick.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        11: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\torch_on.png")).convert_alpha(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        12: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\ladder.png")).convert_alpha(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        13: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\tnt.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        14: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\private.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        15: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\glass.png")).convert_alpha(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        16: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\log_acacia.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        17: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\log_big_oak.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        18: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\log_birch.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        19: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\log_spruce.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        20: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\magma.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        21: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\mushroom_block_inside.png")).convert(screen),
            (TILE_SIZE, TILE_SIZE)),
        22: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\mushroom_block_skin_red.png")).convert(screen),
            (TILE_SIZE, TILE_SIZE)),
        23: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\mushroom_block_skin_brown.png")).convert(screen),
            (TILE_SIZE, TILE_SIZE)),
        24: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\hay_block_side.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        25: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\crafting_table_front.png")).convert(screen),
            (TILE_SIZE, TILE_SIZE)),
        26: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\pumpkin_face_off.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        27: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\debug.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        28: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\debug2.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        29: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\mushroom_red.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        30: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\mushroom_brown.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        31: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\diamond_ore.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        32: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\emerald_ore.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        33: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\gold_ore.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        34: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\iron_ore.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        35: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\nether_brick.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        36: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\redstone_ore.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        37: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\coal_ore.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        38: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\diamond.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        39: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\emerald.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        40: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\gold_ingot.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        41: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\iron_ingot.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        42: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\netherbrick.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        43: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\redstone_dust.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        44: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\charcoal.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        45: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\coal_block.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        46: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\iron_block.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        47: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\cobblestone.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        48: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\gunpowder.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        49: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\sand.png")).convert(screen),
                                   (TILE_SIZE, TILE_SIZE)),
        50: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\stick.png")).convert_alpha(screen),
            (TILE_SIZE, TILE_SIZE)),
        51: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\cobblestone_mossy.png")).convert(screen),
            (TILE_SIZE, TILE_SIZE)),
