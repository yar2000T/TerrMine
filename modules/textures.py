...
def load(pygame, BASE_DIR, PLAYER_SIZE, TILE_SIZE, screen, SCREEN_WIDTH, SCREEN_HEIGHT, globals):
    ...
    globals['textures'] = {
        1: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "dirt.png")).convert(),
                                  (TILE_SIZE, TILE_SIZE)),
        2: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures","grass.png")).convert(),
                                  (TILE_SIZE, TILE_SIZE)),
        3: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "stone.png")).convert(),
                                  (TILE_SIZE, TILE_SIZE)),
        4: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "brick.png")).convert(),
                                  (TILE_SIZE, TILE_SIZE)),
        5: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "diamond.png")).convert(),
                                  (TILE_SIZE, TILE_SIZE)),
        6: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "end_bricks.png")).convert(),
                                  (TILE_SIZE, TILE_SIZE)),
        7: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "planks_oak.png")).convert(),
                                  (TILE_SIZE, TILE_SIZE)),
        8: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "leaves_oak.png")).convert_alpha(),
                                  (TILE_SIZE, TILE_SIZE)),
        9: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "log_oak.png")).convert(),
                                  (TILE_SIZE, TILE_SIZE)),
        10: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "stonebrick.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        11: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "torch_on.png")).convert_alpha(),
                                   (TILE_SIZE, TILE_SIZE)),
        12: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "ladder.png")).convert_alpha(),
                                   (TILE_SIZE, TILE_SIZE)),
        13: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "tnt.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        14: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "private.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        15: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "glass.png")).convert_alpha(),
                                   (TILE_SIZE, TILE_SIZE)),
        16: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "log_acacia.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        17: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "log_big_oak.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        18: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "log_birch.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        19: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "log_spruce.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        20: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "magma.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        21: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "mushroom_block_inside.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        22: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "mushroom_block_skin_red.png")).convert(),
            (TILE_SIZE, TILE_SIZE)),
        23: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "mushroom_block_skin_brown.png")).convert(),
            (TILE_SIZE, TILE_SIZE)),
        24: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "hay_block_side.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        25: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "crafting_table_front.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        26: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "pumpkin_face_off.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        27: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "debug.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        28: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "debug2.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        29: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "mushroom_red.png")).convert_alpha(),
                                   (TILE_SIZE, TILE_SIZE)),
        30: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "mushroom_brown.png")).convert_alpha(),
                                   (TILE_SIZE, TILE_SIZE)),
        31: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "diamond_ore.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        32: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "emerald_ore.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        33: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "gold_ore.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        34: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "iron_ore.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        35: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "nether_brick.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        36: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "redstone_ore.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        37: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "coal_ore.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        ...
        44: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\charcoal.png")).convert_alpha(),
                                   (TILE_SIZE, TILE_SIZE)),
        45: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "coal_block.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        46: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "iron_block.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        47: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "cobblestone.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        48: pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\gunpowder.png")).convert_alpha(),
            (TILE_SIZE, TILE_SIZE)),
        49: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "sand.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        50: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets\\items\\stick.png")).convert_alpha(),
                                   (TILE_SIZE, TILE_SIZE)),
        51: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "cobblestone_mossy.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        52: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "chest.png")).convert(),
                                   (TILE_SIZE, TILE_SIZE)),
        ...
        61: pygame.transform.scale(
            ...
            (TILE_SIZE, TILE_SIZE)),
        100: pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "textures", "bedrock.png")).convert(),
                                    (TILE_SIZE, TILE_SIZE)),
    }
